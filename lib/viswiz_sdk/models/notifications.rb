...
module ViswizSdk
  class Notifications
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'emailEnabled')
        self.email_enabled = attributes[:'emailEnabled']
      end

      if attributes.has_key?(:'slackEnabled')
        self.slack_enabled = attributes[:'slackEnabled']
      end
    ...
    def hash
      [email_enabled, slack_enabled, slack_url].hash
    end
